 ...
 * 2. 사용자가 정의한 클래스에 자동으로 상속이 된다. //extends object...
 *    ==> 단, extends 키워드를 사용하지 않은 클래스에만 상속이 됨. //자바는 단일상속만 되니까!
 *    
 * [Object 클래스의 주요 메서드]
 ...
 *                  
 *                  
 * - getClass() : - 객체 자신의 클래스 정보를 담고 있는 Class
 *                  인스턴스를 반환하는 메서드. 
...
public class Object_01 { // extends Object 생략
	...
	public static void main(String[] args) {
		...
		System.out.println("hashCode() >>> " + ex.hashCode());// identityhascode 값이랑 같음.
